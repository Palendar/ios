...
class CalendarGroupView: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet weak var espacediscussion: UILabel!
    ...
    var eventsStart:[String] = ["24-01-2017 13:30", "25-01-2017 16:00", "01-02-2017 13:30", "01-02-2017 19:00", "02-02-2017 15:30", "03-02-2017 16:00", "05-02-2017 10:30", "25-02-2017 16:00"]
    var eventsEnd:[String] = ["24-01-2017 14:30", "25-01-2017 18:00", "01-02-2017 16:30", "01-02-2017 19:30", "02-02-2017 17:30", "03-02-2017 18:00", "05-02-2017 12:30", "25-02-2017 22:00"]
    var eventText:[String] = ["Réunion Projet", "Rendu Bilan", "Présentation Finale", "Répatition", "Oral PFE", "Lancement Projet", "Restaurant", "Cinéma"]
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        groupName.text = Constante.object(forKey: "groupChoosen") as! String?
        ...
        self.dispoLine.layer.shadowOpacity = 3
        self.dispoLine.layer.shadowOffset = CGSize.zero
        self.viewCal.addSubview(dispoLine)
        
        for i in 0...123{
            let f = UIView()
            f.frame = CGRect(x: 25+(i*25), y: 0, width: 25, height: 5)
    ...
    func loadEvent(){
        ...
        self.dispoLine.removeFromSuperview()
        self.viewCal.addSubview(dispoLine)
    }
    ...
    func afficherEvent(sD : String, eD : String , dE : String){
        ...
        if scale == "hour" && daySelect == jourStart && daySelect == jourEnd && monthSelect == moisStart && monthSelect == moisEnd && yearSelect == yearStart{
            ...
            exemple.frame = CGRect(x: xxx, y: 10, width: www, height: 60)
        ...
        if scale == "hour" && daySelect != jourStart && daySelect == jourEnd && monthSelect == moisStart && monthSelect == moisEnd && yearSelect == yearStart{
            ...
            exemple.frame = CGRect(x: 0, y: 10, width: www, height: 60)
            ...
            case .ended:
                ...
                UIView.animate(withDuration: 0.3, animations: {
                    ...
                    if point.y < 150{
                        ...
                        self.Constante.set("Group", forKey: "beforeAdd")
